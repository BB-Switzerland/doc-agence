...
### 1. Connexion à Infomaniak 
   ...
   ![Connexion à Infomaniak](./img/save_bdd_1.png)

### 2. Accéder au menu "Web & Domain"  
   Une fois connecté, cliquez sur **Web & Domain** dans la barre de navigation à droite.  
...
### 5. Accéder aux paramètres de l'application 
   ...
   ![Paramètres de l'application](./img/save_bdd_5.png)
...
### 6. Copier le nom de la base de données 
   ...
   ![Nom de la base de données](./img/save_bdd_6.png)
...
### 8. Rechercher la base de données
   ...
   ![Rechercher la base de données](./img/save_bdd_8.png)
...
### 9. Télécharger la sauvegarde
   ...
   ![Télécharger une sauvegarde](./img/save_bdd_9.png)
...
### 10. Confirmer le téléchargement  
   ...
   ![Téléchargement de la sauvegarde](./img/save_bdd_10.png)
