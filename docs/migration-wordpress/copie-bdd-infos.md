...
Ces informations sont essentielles pour connecter votre site à la base de données lors de la mise en ligne.
...
Gardez ces informations à portée de main, par exemple dans une note, car elles seront nécessaires plus tard dans le processus de mise en ligne.
