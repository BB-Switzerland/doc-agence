...
Copie le prompt ci-dessous **en entier**, colle-le dans **Sidekick**, et **joins le PDF du devis signé**.

La procédure complète est décrite sur la page [Onboarder un projet depuis un devis](../02-work-management/onboarding-projet-sidekick.md).
:::
...
ÉTAPE 6 — Pour chaque item ayant des sous-éléments, crée les subitems dans le board 5097430830 (ordre exact) :
   numeric_mm3xybp8 = Heures prévues · color_mm44djn3 = Phases créa.
